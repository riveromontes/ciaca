...
class CompraController extends Controller
{
    ...
    public function index(Request $request)
    {
      ...
      //Aquí se ejecutan los scopes
      //$user_id = $request->get('user_id');
      $cedula_piloto = $request->get('cedula_piloto');
      ...
      return view('compras.index', compact('compras', ['cedula_piloto',
    ...
    public function create()
    {
      ...
      return view('compras.create', compact('users', 'estudiantes'));
    }
    ...
    public function store(Request $request)
    {
      ...
      return redirect()->route('compras.create', $compra->id)
